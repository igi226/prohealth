                   ...
                   <div class="basic-form">
                       <form action="{{ route('packages.update', $package->slug) }}" method="post">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter package name....." name="package_name" value="{{ $package->package_name }}">
                            ...
                            <select name="package_type" class="form-control">
                                ...
                                <option {{  $package->package_type == "Yearly" ? "selected" : ""  }} value="Yearly">Yearly</option>
                            ...
                            <div class="form-group">
                                <label>Available consultation</label>
                                <input type="number" class="form-control"  name="available_consultation" value="{{ $package->available_consultation }}">
                                @if ($errors->has('available_consultation'))
                                    <span class="text-danger">{{ $errors->first('available_consultation') }}</span>
                                @endif
                            </div>
