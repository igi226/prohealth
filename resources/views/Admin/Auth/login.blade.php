            ...
            <div id="login" class="row g-0 align-items-center">
               <div class="col-12">
                  <div id="login__container">
                    ...
                    @endif
                     <form  id="login__container--form" action="{{ route('admin.loggedin') }}" method="post">
                        @csrf
                        <p class="login-username">
                           <label for="user_login">Email Address</label>
                           <input name="email" type="text" id="user_login"
                        ...
                        <p class="login-password">
                           ...
                           <input name="password" type="password" id="user_pass" class="input" value="" size="20" />
